...
<body class="dark:bg-gray-900">
	...
	<div class="mx-auto">
		  ...
		  <ol class="inline-flex items-center space-x-1 md:space-x-3">
			...
			<li>
			  <div class="flex items-center">
				...
				<p class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400"><?php echo $title['search-blessing']; ?></p>
			  </div>
			</li>
		  </ol>
		</nav>
		...
		<div>
			<h2 class="flex items-center mb-1 text-xl font-bold text-gray-900 dark:text-white"><?php echo $title['search-blessing']; ?></h2>
			<hr class="border-gray-300 dark:border-gray-600 my-3"/> 
				<div class="relative sm:rounded-lg" style="width:850px;">
				<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                        <tr>
								<th scope="col" class="px-6 py-3"><?php echo $transaction['lantern-id']; ?></th>
								...
								<th scope="col" class="px-6 py-3"><?php echo $transaction['blessing-receipt']; ?></th>
								<th scope="col" class="px-6 py-3"><?php echo $transaction['votive-receipt']; ?></th>
							<!--
                    ...
                    <tbody> 
			            <?php 
						$query = $conn->query("SELECT * FROM BLantern ORDER BY BLantern_id");  
			            if($query->num_rows > 0){
                        ...
                        <tr class='border-b dark:bg-gray-800 dark:border-gray-700 odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700'>
                            ...
                            <!--
								<td class="px-6 py-4 text-right">
									<a href="edit-blantern.php?name=transaction&Id=<?php echo $row['BLantern_id']; ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline"><?php echo $form['btnedit']; ?></a>
								</td>
                        	-->
                        </tr>
			            <?php 
