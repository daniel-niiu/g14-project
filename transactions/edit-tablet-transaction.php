...
<body class="dark:bg-gray-900">
	...
	<div class="mx-auto">
		...
		<div>
			...
			<form method="post" action="../php/tablet-transaction.php?method=update&Id=<?php echo $row["Tablet_id"]; ?>&receiptNum=<?php echo $row['receipt_num']; ?>&receiptDate=<?php echo $row['receipt_date'];?>">
