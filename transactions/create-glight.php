	...
	<div class="mx-auto">
		  ...
		  <ol class="inline-flex items-center space-x-1 md:space-x-3">
			...
			<li>
			  <div class="flex items-center">
				...
				<p class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400"><?php echo $title['create-light']; ?></p>
			  </div>
			</li>
		  </ol>
		</nav>
		...
		<div>
			<div class="container flex flex-wrap justify-between items-center mx-auto">
				<h2 class="flex items-center mb-1 text-xl font-bold text-gray-900 dark:text-white"><?php echo $title['create-light']; ?></h2>
						...
						<div class="relative p-4 w-full max-w-md h-full md:h-auto">
							<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
								...
								<div class="py-6 px-6 lg:px-8">
									...
									<form method="post" action="glight_import.php" id="import_excel_form" enctype="multipart/form-data">
										<div class="mb-4">
											<div class="grid gap-6 md:grid-cols-2">
                                                ...
                                                <div>
                                                    <a href="../php/glight.php?method=quick_export" class="text-sm font-medium text-blue-700 dark:text-gray-300 hover:text-blue-800 dark:hover:text-white hover:underline cursor-pointer" style="float:right;"><?php echo $import['download-template']; ?></a>
                                                </div>
                                            </div>
			...
			<form method="post" action="../php/glight.php?method=add" onsubmit="return glight_validation()">
    			<div class="grid gap-6 mb-6 md:grid-cols-2">
					<div>
						<label for="id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo $transaction['light-id']; ?><span class="text-red-500 dark:text-red-300">*</span></label>
						<input type="text" id="gl-id" name="gl-id" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="<?php echo $transaction['light-id']; ?>">
					...
					<div>
						...
						<div class="flex">
  						...
  						<p class='text-xs font-normal text-red-500 dark:text-red-300 mt-1 ml-1' id="p_r_amount" style="display:none;"><?php echo $form['empty-warning']; ?></p>
					 </div>
					<div>
