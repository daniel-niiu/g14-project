...
<body class="dark:bg-gray-900">
	...
	<div class="mx-auto">
		...
		<div>
			...
			<form method="post" action="../php/blantern.php?method=add">
				...
				<div class="grid xl:grid-cols-2 xl:gap-6">
					<div class="relative z-0 w-full mb-6 group">
						...
						<input type="text" id="blessing" name="blessing_receipt" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="R000">
					 </div>
					<div class="relative z-0 w-full mb-6 group">
						<label for="votive" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Votive Receipt</label>
						<input type="text" id="votive" name="votive_receipt" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="R000">
					 </div>
				 </div>
				<div class="grid xl:grid-cols-2 xl:gap-6">
					<div class="relative z-0 w-full mb-6 group">
