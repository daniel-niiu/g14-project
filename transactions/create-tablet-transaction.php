...
<body class="dark:bg-gray-900">
			...
			<div class="container flex flex-wrap justify-between items-center mx-auto">
				...
				<div class="flex justify-between">
					<button type="button" class="text-white bg-gradient-to-r from-teal-400 via-teal-500 to-teal-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-teal-300 dark:focus:ring-teal-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" data-modal-toggle="import-modal1">
						<i class="fa-solid fa-file-import"></i>&nbsp; Import Transaction Record
					</button>
						...
						<div class="relative p-4 w-full max-w-md h-full md:h-auto">
							<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
								...
								<div class="py-6 px-6 lg:px-8">
									<h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white">Import Transaction Record</h3>
			...
			<form method="post" action="../php/tablet-transaction.php?method=add" onsubmit="return tablet_transaction_validation()">
				<div class="grid xl:grid-cols-2 xl:gap-6">
					...
					<div class="relative z-0 w-full mb-6 group">
						...
						<p class='text-xs font-normal text-red-500 dark:text-red-300 mt-1 ml-1' id="p_r_no" style="display:none;">*Not allowed to empty and special character
						</p>
					 </div>
				 </div>
				<div class="grid xl:grid-cols-2 xl:gap-6">			
					...
					<div class="relative z-0 w-full mb-6 group">
						...
						<div class="flex">
						 ...
						 <p class='text-xs font-normal text-red-500 dark:text-red-300 mt-1 ml-1' id="p_amount" style="display:none;">*Not allowed to empty, alphabets and special character</p>
						</div>
					 </div>
				 </div>
				<div class="grid xl:grid-cols-2 xl:gap-6">
	...
	<div id="toast-success" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 fixed bottom-5 left-5" role="alert">
		...
		<div class="ml-3 text-sm font-normal">Receipt created successfully.</div>
	...
	<div id="toast-danger" class="flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 fixed bottom-5 left-5" role="alert">
		...
		<div class="ml-3 text-sm font-normal">Receipt has been created before.</div>
