		...
		<div>
			...
			<form method="post" action="../php/blantern.php?method=update&Id=<?php echo $row['BLantern_id']; ?>" onsubmit="return blessing_validation()">
				...
				<div class="relative z-0 w-full mb-6 group">
					...
					<textarea id="remarks" name="remarks" rows="3" cols="125" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400"><?php echo $row['remarks']; ?></textarea>
				</div>
