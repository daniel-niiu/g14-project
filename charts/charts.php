...
?>
            ...
            <?php 
              ...
              while ($result = mysqli_fetch_assoc($tablet)) {
                $tablet_array_lump_sum[] = array('date' => $result['receipt_date'], 'amount' => $result['amount']);
              } 
              ...
              while ($result = mysqli_fetch_assoc($tablet1)) {
                $tablet_array_over_time[] = array('date' => $result['receipt_date'], 'amount' => $result['amount']);
              }   
...
<html>
      ...
      chart.draw(data, google.charts.Line.convertOptions(options));
        ...
        function YearlyLineChart() {
            ...
            data.addRows([
              ...
              /*
                for($i =0; $i < count($tablet_monthly); $i++)
                  echo "[".$tablet_monthly[$i][0].",".$tablet_monthly[$i][1].",".$tablet_monthly[$i][2]."],";
                  */
              ?>
            ]);
            ...
            var chart = new google.charts.Line(document.getElementById('transaction_piechart'));
  ...
  <body>
    <div>
    <div id="member_type_piechart" style="width: 50%; height: 500px; float:left;"></div>
    <div id="member_active_piechart" style="width: 50%; height: 500px; float:left;"></div>
    <div id="new_member_linechart" style="width: 100%; height: 500px; float:left;"></div>
    <div id="linechart_material" style="width: 100%; height: 500px; float:left;"></div>
    <div id="transaction_piechart" style="width: 100%; height: 500px; float:left;"></div>
  </div>
  </body>
</html>