...
<body class="dark:bg-gray-900">
	...
	<div class="mx-auto">
		  ...
		  <ol class="inline-flex items-center space-x-1 md:space-x-3">
			...
			<li>
			  <div class="flex items-center">
				...
				<p class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400">Search Account</p>
			  </div>
			</li>
		  </ol>
		</nav>
		...
		<div>
			<h2 class="flex items-center mb-1 text-xl font-bold text-gray-900 dark:text-white">Search Account</h2>
