...
<body class="dark:bg-gray-900">
	...
	<div class="mx-auto">
		  ...
		  <ol class="inline-flex items-center space-x-1 md:space-x-3">
			...
			<li>
			  <div class="flex items-center">
				...
				<p class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400"><?php echo $title['search-account']; ?></p>
			  </div>
			</li>
		  </ol>
		</nav>
		...
		<div>
			<h2 class="flex items-center mb-1 text-xl font-bold text-gray-900 dark:text-white"><?php echo $title['search-account']; ?></h2>
				...
				<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
					<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
						<thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
							<tr>
								<th scope="col" class="px-6 py-3"><?php echo $account['full-name']; ?></th>
								<th scope="col" class="px-6 py-3"><?php echo $account['email-address']; ?></th>
								<th scope="col" class="px-6 py-3"><?php echo $account['account-type']; ?></th>
								<th scope="col" class="px-6 py-3"><?php echo $account['account-status']; ?></th>
						...
						<tbody>
				            ...
				            <?php
			                	...
			                	echo '<tr><td colspan="4">'.$form['no-record-warning'].'</td></tr>'; 
			                } 
	                    	?>  
						</tbody>
					</table>
