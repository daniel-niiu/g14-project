...
<body class="dark:bg-gray-900">
	...
	<div class="mx-auto">
		  ...
		  <ol class="inline-flex items-center space-x-1 md:space-x-3">
			...
			<li>
			  <div class="flex items-center">
				...
				<a href="search-account.php?name=account&aside=search-account" class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400">Search Account</a>
			  </div>
			</li>
			<li>
			  <div class="flex items-center">
				<svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
				<p class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400">View Account</p>
			  </div>
			</li>
		  </ol>
		</nav>
		...
		<div>
			<div class="container flex flex-wrap justify-between items-center mx-auto">
				<h2 class="flex items-center mb-1 text-xl font-bold text-gray-900 dark:text-white">View Account</h2>
				<div class="flex justify-between">
					<a href="edit-account.php?name=edit-account">
          ...
          <form>
              <div class="grid xl:grid-cols-2 xl:gap-6">
                  <div class="relative z-0 w-full mb-6 group">
                      <!--User: For admin to record the name of the user who will use the account-->
                  ...
                  <div class="relative z-0 w-full mb-6 group">
                      ...
                      <input type="text" id="email" name="email" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400" value="<?php echo $row['member_id']; ?>" disabled readonly>
                  </div>
               </div>
              <div class="grid xl:grid-cols-2 xl:gap-6">
                  <div class="relative z-0 w-full mb-6 group">
                      <label for="account" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Account Type</label>
                      <input type="text" id="account" name="account" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400" value="<?php echo $row['member_status']; ?>"disabled readonly>
                   </div>
                  <div class="relative z-0 w-full mb-6 group">
                      <!--Department: Is the operator responsible for (1) membership, (2) transactions or (3) product and stocks?-->
                      <label for="department" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Department</label>
                      <input type="text" id="department" name="department" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400" value="<?php echo $row['member_eng_name']; ?>" disabled readonly>
                  </div>
               </div>
              <div class="grid xl:grid-cols-2 xl:gap-6">
                  <div class="relative z-0 w-full mb-6 group">
                      <label for="admin" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Created By</label>
                      <input type="text" id="admin" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400" value="<?php echo $row['username']; ?>" disabled readonly>
                  </div>
                  <div class="relative z-0 w-full mb-6 group">
                      <label for="create-date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Created On</label>
                      <input type="text" id="create-date" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400" value="<?php echo $row['username']; ?>" disabled readonly>
                  </div>
               </div>
			  <div class="relative z-0 w-full mb-6 group">
	...
	<div id="toast-success" class="hidden flex items-center w-full max-w-xs p-4 mb-4 text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800 fixed bottom-5 left-5" role="alert">
		...
		<div class="ml-3 text-sm font-normal">Details modified successfully.</div>
