	...
	<div class="mx-auto">
		  ...
		  <ol class="inline-flex items-center space-x-1 md:space-x-3">
			...
			<li>
			  <div class="flex items-center">
				...
				<p class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400"><?php echo $title['create-product']; ?></p>
			  </div>
			</li>
		  </ol>
		</nav>
		...
		<div>
			<div class="container flex flex-wrap justify-between items-center mx-auto">
				<h2 class="flex items-center mb-1 text-xl font-bold text-gray-900 dark:text-white"><?php echo $title['create-product']; ?></h2>
						...
						<div class="relative p-4 w-full max-w-md h-full md:h-auto">
							<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
								...
								<div class="py-6 px-6 lg:px-8">
									...
									<form method="post" id="import_excel_form" action="product_import.php" enctype="multipart/form-data">
										<div class="mb-4">
											<div class="grid gap-6 md:grid-cols-2">
                                                ...
                                                <div>
                                                    <a href="../php/product.php?method=quick_export" class="text-sm font-medium text-blue-700 dark:text-gray-300 hover:text-blue-800 dark:hover:text-white hover:underline cursor-pointer" style="float:right;"><?php echo $import['download-template']; ?></a>
                                                </div>
                                            </div>
					...
					<div>
				 	...
				 	<div>
						...
						<label for="checkbox" class="inline-flex relative items-center cursor-pointer mt-1">
						  ...
						  <span id="status" class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo $product['status-available']; ?></span>
