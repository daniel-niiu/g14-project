...
<head>
	...
	<link rel="stylesheet" href="https://unpkg.com/flowbite@1.5.2/dist/flowbite.min.css" /><?php 
// Include pagination library file 
include_once '../php/Pagination.class.php'; 
				...
				<table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody> 
                        ...
                        <tr class='border-b dark:bg-gray-800 dark:border-gray-700 odd:bg-white even:bg-gray-50 odd:dark:bg-gray-800 even:dark:bg-gray-700'>
                            ...
                            <td class='px-6 py-4 text-right'><a href='edit-product.php?name=product&Id=<?php echo $row["member_id"];?>' class='font-medium text-blue-600 dark:text-blue-500 hover:underline'>Edit</a></td>
                        </tr>
			            <?php 
			                } 
			            }else{ 
