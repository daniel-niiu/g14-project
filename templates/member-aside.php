            	...
            	<div class="px-6 py-6 lg:px-8">
                	...
                	<form class="space-y-6" action="#">
						<div class="grid xl:grid-cols-2 xl:gap-6">
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="id" type="checkbox" name="selection" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" >
									<label for="id" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Member ID</label>
								</div>
							</div>
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="name" type="checkbox" name="selection" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
						...
						<div class="grid xl:grid-cols-2 xl:gap-6">
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="ic" type="checkbox" name="selection" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
									<label for="ic" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">NRIC</label>
								</div>
							</div>
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="citizen" type="checkbox" name="selection" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
						...
						<div class="grid xl:grid-cols-2 xl:gap-6">
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="age" type="checkbox" name="selection" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
									<label for="age" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Age</label>
								</div>
							</div>
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="gender" type="checkbox" name="selection" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
						...
						<div class="grid xl:grid-cols-2 xl:gap-6">
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="dob" type="checkbox" value="" name="selection" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
									<label for="dob" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Date of Birth</label>
								</div>
							</div>
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="contact" type="checkbox" value="" name="selection" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
						...
						<div class="grid xl:grid-cols-2 xl:gap-6">
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="job" type="checkbox" value="" name="selection" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
									<label for="job" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Occupation</label>
								</div>
							</div>
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="address" type="checkbox" name="selection" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
						...
						<div class="grid xl:grid-cols-2 xl:gap-6">
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="member" type="checkbox" name="selection" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
									<label for="member" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Member Type</label>
								</div>
							</div>
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="accept-date" type="checkbox" name="selection" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
						...
						<div class="grid xl:grid-cols-2 xl:gap-6">
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="recommender-id" type="checkbox" name="selection" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
									<label for="recommender-id" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Recommender ID</label>
								</div>
							</div>
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="recommender" type="checkbox" name="selection" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
						...
						<div class="grid xl:grid-cols-2 xl:gap-6">
							<div class="relative z-0 w-full group">
								<div class="flex items-center">
									<input id="remarks" type="checkbox" name="selection" value="" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
