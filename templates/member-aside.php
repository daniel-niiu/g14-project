        ...
        <ul class="pt-4 mt-4 space-y-2 border-t border-gray-300 dark:border-gray-600">
            ...
            <li>
                <a class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg transition duration-75 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-white dark:text-gray-400 group cursor-pointer" data-modal-toggle="export-modal">
                    ...
                    <span class="ml-4">Export Record</span>
                </a>
            </li>
        </ul>
    </div>
                    ...
                    <div class="grid xl:grid-cols-2 xl:gap-6">
                        ...
                        <div class="relative z-0 w-full group">
                            <div class="flex items-center">
                                ...
                                <label for="name" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">English Name</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="grid xl:grid-cols-2 xl:gap-6">
                        <div class="relative z-0 w-full group">
                            <div class="flex items-center">
                                ...
                                <label for="ic" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Chinese Name</label>
                            </div>
                        </div>
                        <div class="relative z-0 w-full group">
                            <div class="flex items-center">
                    ...
                    <div class="grid xl:grid-cols-2 xl:gap-6">
                        <div class="relative z-0 w-full group">
                            <div class="flex items-center">
                                ...
                                <label for="age" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">Citizenship</label>
                            </div>
                        </div>
                        <div class="relative z-0 w-full group">
                            <div class="flex items-center">
