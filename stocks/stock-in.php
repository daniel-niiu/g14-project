...
<body class="dark:bg-gray-900">
	...
	<div class="mx-auto">
		...
		<div>
			...
			<?php  
			$M_NAME = $_GET['Name'];
	    	$sql = "SELECT * FROM stock WHERE product_eng_name = '".$M_NAME."'"; 	 
			...
			<form method="post" action="../php/member.php?method=add=<?php echo $M_NAME; ?>">
				<div class="grid xl:grid-cols-2 xl:gap-6">
					<div class="relative z-0 w-full mb-6 group">
						<label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Product Name*</label>
						<input type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" value="<?php echo $row['product_eng_name']; ?>" placeholder="Product Name" required>
					</div>
					<div class="relative z-0 w-full mb-6 group">
