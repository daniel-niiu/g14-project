...
<body class="dark:bg-gray-900">
	...
	<div class="mx-auto">
		  ...
		  <ol class="inline-flex items-center space-x-1 md:space-x-3">
			...
			<li>
			  <div class="flex items-center">
				...
				<p class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400"><?php echo $title['stock-in'];?></p>
		...
		<div>
			...
			<div class="container flex flex-wrap justify-between items-center mx-auto">
				<h2 class="flex items-center mb-1 text-xl font-bold text-gray-900 dark:text-white"><?php echo $title['stock-in'];?></h2>
						...
						<div class="relative p-4 w-full max-w-md h-full md:h-auto">
							<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
								...
								<div class="py-6 px-6 lg:px-8">
									...
									<form method="post" action="stock_in_import.php" id="import_excel_form" enctype="multipart/form-data">
										<div class="mb-4">
											<div class="grid gap-6 md:grid-cols-2">
                                                ...
                                                <div>
                                                    <a href="../php/stockin.php?method=quick_export" class="text-sm font-medium text-blue-700 dark:text-gray-300 hover:text-blue-800 dark:hover:text-white hover:underline cursor-pointer" style="float:right;"><?php echo $import['download-template']; ?></a>
                                                </div>
                                            </div>
	...
	<script> 
        $(document).ready(function () {
            ...
            $("#stock-in").keyup(function(){ 
            	var quantity = $('#stock-in').val(); 
            	var searchField = $('#search').val(); 
            	$.ajax({
            		url: "fetch_stock_productname.php",
            		type: "post",
