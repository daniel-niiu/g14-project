	...
	<div class="mx-auto">
		  ...
		  <ol class="inline-flex items-center space-x-1 md:space-x-3">
			...
			<li>
			  <div class="flex items-center">
				...
				<a href="../products/view-product.php" class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400">View Product</a>
			  </div>
			</li>
			<li>
			  <div class="flex items-center">
				<svg class="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
				<p class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400">View Stock</p>
			  </div>
			</li>
		  </ol>
		</nav>
		...
		<div>
			<div class="container flex flex-wrap justify-between items-center mx-auto">
				<h2 class="flex items-center mb-1 text-xl font-bold text-gray-900 dark:text-white">View Stock</h2>
				<div class="button">
					<a href="edit-stock.php?name=stock&Id=<?php echo $row["PID"]; ?>&receiptNum=<?php echo $row['receipt']; ?>&receiptDate=<?php echo $row["date"]; ?>">
					...
					<button type="button" class="text-white bg-gradient-to-r from-red-400 via-red-500 to-red-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2" data-modal-toggle="delete-popup-modal">
						<i class="fa-solid fa-trash-can"></i>&nbsp; Delete Stock
					</button> 
			...
			<form>
				<div class="grid xl:grid-cols-2 xl:gap-6">
					...
					<div class="relative z-0 w-full mb-6 group">
						...
						<div class="relative">
  							...
  							<input datepicker datepicker-format="dd/mm/yyyy" datepicker-buttons type="text" id="date" name="date" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400 pl-10" value="<?php echo date("d-m-Y", strtotime($row['date'])); ?>" disabled readonly>
						</div>
					</div>
				</div>
				...
				<div class="grid xl:grid-cols-2 xl:gap-6">
					...
					<div class="relative z-0 w-full mb-6 group">
						...
						<input type="text" id="receipt" name="receipt" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400" value="<?php echo $row['receipt']; ?>" disabled readonly>
					 </div>
				</div>
				
				<div class="grid xl:grid-cols-2 xl:gap-6">
					<div class="relative z-0 w-full mb-6 group">
						<label for="stock-in" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Stock In</label>
					...
					<div class="relative z-0 w-full mb-6 group">
						<label for="stock-out" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Stock Out</label>
						<input type="text" id="stock-out" name="stock-out" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400" value="<?php echo $row['stock_out']; ?>" disabled readonly>
					 </div>
				</div>
				<div class="grid xl:grid-cols-2 xl:gap-6">
					<div class="relative z-0 w-full mb-6 group">
						<label for="balance" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Balance</label>
						<div class="flex">
