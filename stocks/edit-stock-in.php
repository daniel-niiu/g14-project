...
<body class="dark:bg-gray-900">
	...
	?>
		...
		<?php   
		    ...
		    $sql = "SELECT p.remarks AS p_remarks, s.remarks AS s_remarks, s.product_name AS PName, receipt_no AS receipt, reciept_date AS date, stock_summary AS summary, stock_in AS stock_in, balance_left AS balance FROM stockin AS s, product AS p WHERE s.product_name = p.product_id AND s.product_name = '".$name."' AND receipt_no = '".$receipt_No."' AND reciept_date = '".$receipt_Date."'";  	  
