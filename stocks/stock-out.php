...
<body class="dark:bg-gray-900">
	...
	<div class="mx-auto">
		  ...
		  <ol class="inline-flex items-center space-x-1 md:space-x-3">
			...
			<li>
			  <div class="flex items-center">
				...
				<p class="ml-1 text-sm font-medium text-gray-700 md:ml-2 dark:text-gray-400"><?php echo $title['stock-out']; ?></p>
			  </div>
			</li>
		  </ol>
		</nav>
		...
		<div>  
						...
						<div class="relative p-4 w-full max-w-md h-full md:h-auto">
							<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
								...
								<div class="py-6 px-6 lg:px-8">
									<h3 class="mb-4 text-xl font-medium text-gray-900 dark:text-white"><?php echo $import['import-tablet']; ?></h3>
									<form method="post" action="stock_out_import.php" id="import_excel_form" enctype="multipart/form-data">
										<div class="mb-4">
											<div class="grid gap-6 md:grid-cols-2">
                                                ...
                                                <div>
                                                    <a href="../php/stockout.php?method=quick_export" class="text-sm font-medium text-blue-700 dark:text-gray-300 hover:text-blue-800 dark:hover:text-white hover:underline cursor-pointer" style="float:right;"><?php echo $import['download-template']; ?></a>
                                                </div>
                                            </div>
			...
			<form method="post" action="../php/stockout.php?method=add" onsubmit="return stockout_validation()">
    			<div class="grid gap-6 mb-6 md:grid-cols-2">
					<div>
						...
						<p class='text-xs font-normal text-red-500 dark:text-red-300 mt-1 ml-1' id="p_id" style="display:none;"><?php echo $form['id-warning']; ?></p>
					...
					<div>
						...
						<p class='text-xs font-normal text-red-500 dark:text-red-300 mt-1 ml-1' id="p_receipt" style="display:none;"><?php echo $form['id-warning']; ?></p>
					 </div>
					<div>
						<label for="stock-out" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"><?php echo $stock['quantity-out']; ?><span class="text-red-500 dark:text-red-300">*</span></label>
						<input type="text" id="stock-out" name="stock-out" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="<?php echo $title['stock-out']; ?>">
					...
					<div>
						...
						<div class="flex">
							 ...
							 <input type="text" id="balance1" name="balance1" class="rounded-none rounded-r-lg bg-gray-50 border text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="<?php echo $stock['balance']; ?>" disabled>
							 <input type="hidden" id="balance" name="balance">
						</div>
						<p class='text-xs font-normal text-red-500 dark:text-red-300 mt-1 ml-1' id="p_balance" style="display:none;"><?php echo $form['number-warning']; ?></p>
					 </div>
				</div>
	...
	<?php 
	$export_status = $_GET['import_status']; 
	...
	<script> 
        $(document).ready(function () {
            ...
            $("#stock-out").keyup(function(){ 
            	var quantity = $('#stock-out').val(); 
            	var searchField = $('#search').val(); 
            	$.ajax({
            		url: "fetch_stock_productname.php",
            		type: "post",
