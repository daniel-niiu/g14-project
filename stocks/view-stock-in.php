...
<body class="dark:bg-gray-900">
	...
	<div class="mx-auto">
		...
		<?php   
		    ...
		    $sql = "SELECT p.product_id ,s.recordedBy, s.recordedOn, p.remarks AS p_remarks, s.remarks AS s_remarks, s.product_name AS PName, receipt_no AS receipt, reciept_date AS date, stock_in AS stock_in, balance_left AS balance FROM stockin AS s, product AS p WHERE s.product_name = p.product_id AND s.product_name = '".$name."' AND receipt_no = '".$receipt_No."' AND reciept_date = '".$receipt_Date."'"; 	  
			...
			<form>
    			<div class="grid gap-6 mb-6 md:grid-cols-2">
					...
					<div>
						...
						<input type="text" id="date" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-gray-400"  value="<?php echo date("d-m-Y", strtotime($row['date'])); ?>" disabled readonly>
					</div>
					<div>
