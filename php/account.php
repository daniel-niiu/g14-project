...
if($method === "add")
{
    ...
    $sql = "INSERT INTO admin (admin_username, admin_password, admin_status, admin_type) VALUES ('".$_POST['email']."','".md5($userpassword)."','".$_POST['account-status']."','".$acc_type."')"; 
...
if($method === "update")
{
    ...
    if($email == "admin"){ 
        ...
        $sql = "UPDATE admin SET admin_status = '".$_POST['account-status']."' , admin_type = '".$acc_type."' WHERE admin_username = '".$email."'"; 
