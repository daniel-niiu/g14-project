...
if($method === "add")
{
    ...
    if ($row['row'] == 0) { 
	    ...
	    $sql = "INSERT INTO STOCKOUT(product_name, reciept_date, stock_summary, receipt_no, stock_out, balance_left, remarks, recordedBy, recordedOn) VALUES('$prodname[0]','$date','$summary','$receiptno','$stockout','$balance','$remarks', '".$_SESSION['name']."', '".date("Y-m-d H:i:s")."')";  
