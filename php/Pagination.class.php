...
class Pagination{ 
    ...
    var $fullTagOpen    = '<ul class="inline-flex -space-x-px">'; 
    var $fullTagClose   = '</ul>'; 
    var $firstTagOpen   = ''; 
    var $firstTagClose  = ''; 
    var $lastTagOpen    = ''; 
    ...
    */
    ...
    var $curTagOpen  = '<li><a aria-current="page" class="py-2 px-3 text-blue-600 bg-blue-50 border border-gray-300 hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">';
    ...
    function getAJAXlink( $count, $text) { 
        if($this->link_func == '' && $this->contentDiv == '') 
            return '<li><a href="'.$this->baseURL.'?'.$count.'"'.$this->anchorClass.' class="py-2 px-3 ml-0 leading-tight text-gray-500 bg-white rounded-l-lg border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">'."asd".$text.'</a></li>'; 
        ...
        return "
                <li><a href=\"javascript:void(0);\"  " . $this->anchorClass . " 
                ". $linkClick ." class=\"py-2 px-3 leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white\">". $this->anchorClass.$text .'</a></li>'; 
    } 
} 
?>